...
export const publicKey = fs ? (process.env.JWT_PUBLIC_KEY ? process.env.JWT_PUBLIC_KEY : fs.readFileSync('encryptionkeys/jwt.pub', 'utf8')) : (process.env.JWT_PUBLIC_KEY || 'placeholder-public-key')
